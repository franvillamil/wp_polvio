...
\begin{itemize}
  ...
  \only<1>{\item Why were so many independent states in Europe fighting each other? maybe it has to do with the failure of other systems?}
  % \only<1>{\item Not random, it needs to be explained, }
