...
\visible<3>{\includegraphics[width = \textwidth]{img/combatants-noncombatant1}}
\visible<4>{\includegraphics[width = \textwidth]{img/combatants-noncombatant2}}
