...
\begin{itemize}
  \item<1-> Key aspect: distinction between \BGyellow{battle violence} and \BGyellow{violence against civilians}
  \begin{itemize}
...
\only<2-3>{
\begin{itemize}
  \item For example, what's the pattern of \BGyellow<2>{Hamas}? \only<3>{\BGyellow<3>{Israel IDF}?}
\end{itemize}}
...
\begin{itemize}
  ...
  \end{itemize}
  \item[]
  \item<2-> Sometimes \textit{intentionality} could not be ignored (e.g. genocides, ethnic violence): \BGyellow{ancient hatreds}
\end{itemize}
...
\begin{itemize}
  ...
  \item<2-> Civilians are \textbf{not bystanders} to a war, they play a \BGyellow{central role} (offering support, human resources, etc) and, sometimes, they become the object of war
  \item<3-> Most attention on \BGyellow{\textit{state-led} violence against civilians}: because of their capacities (to inflict violence \& to control territory and have access to the civilian population), states have usually been the main perpetrators
  \begin{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
  \item[]
  \item<2-> Main idea: political \BGyellow{elites} obtain political \textbf{benefits by promoting violence}
  \begin{itemize}
...
\begin{itemize}
  \item<1-> \BGyellow{Ethnic outbidding}
  \begin{itemize}
  ...
  \end{itemize}
  \item<2-> \BGyellow{Role of ideology}
  \begin{itemize}
  ...
  \end{itemize}
  \item<3-> \BGyellow{Getting away} with violence
  \begin{itemize}
...
\begin{itemize}[<+->]
  \item Different, more recent approach: studying within-conflict dynamics, using \BGyellow{micro-level} data
...
\begin{itemize}
  ...
  \item<2-> But do \BGyellow{political identities} play a role?
...
\begin{itemize}
  \item The key idea is that killing civilians often responds to \BGyellow{\textbf{strategic incentives}}, not so much to irrationality
